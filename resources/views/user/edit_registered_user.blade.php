                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateUser', ['user'=>$user->id]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select form-control @error('role') is-invalid @enderror" id="role" name="role" value="value" required aria-label="Disabled select example">
                                    @foreach(config('roles.values') as $roleValue)
                                        <option
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="subject" type="text" class="form-control @error('subject') is-invalid @enderror" name="subject" value="{{ $user->subject }}" autocomplete="subject" autofocus>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-warning" href="/users" tabindex="-1" aria-disabled="true">Cofnij</a>
                            </div>
                        </div>
                    </form>
                </div>
